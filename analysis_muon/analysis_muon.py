...
np.save('/lustre/neutrino/weizhenyu/analysis_muon/data_npy/l1_e_list_3_10.npy', l1_e_list)
np.save('/lustre/neutrino/weizhenyu/analysis_muon/data_npy/not_l1_e_list_3_10.npy', not_l1_e_list)
np.save('/lustre/neutrino/weizhenyu/analysis_muon/data_npy/l1_dis_list_3_10.npy', l1_dis_list)
np.save('/lustre/neutrino/weizhenyu/analysis_muon/data_npy/not_l1_dis_list_3_10.npy', not_l1_dis_list)
#%%         
# plt.figure(dpi = 800)
# range_ = [0,200]
# bins_ = 50
