...
void TrackerHit::Print()
{
  ...
  //G4cout << "fill tuple in trackhit.cc" << G4endl;
  analysisManager ->FillNtupleDColumn(0,fTime / ns);
  // analysisManager ->FillNtupleDColumn(2,cp_number);
  //analysisManager ->FillNtupleDColumn(2,cp_number_theta);
  analysisManager ->FillNtupleDColumn(1,fEnergy / eV);
